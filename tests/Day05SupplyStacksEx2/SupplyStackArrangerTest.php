...
use Kata\Day05SupplyStacksEx2\SupplyStackArranger;
...
class SupplyStackArrangerTest extends TestCase
{
    ...
    */
    public function should_move_many_crates(): void
    {
        ...
        self::assertEquals('AZ', SupplyStackArranger::execute($stacks, $movements));
    }
    ...
    */
    public function should_move_crates_in_many_movements(): void
    {
        ...
        self::assertEquals('AYG', SupplyStackArranger::execute($stacks, $movements));
    }
}
